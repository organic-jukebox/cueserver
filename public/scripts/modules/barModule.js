define(function() {
  ...
  barModule.prototype.update = function(now, pixnow) {
    ...
    if (pixY > obj.lastPixY) {
      if ((obj.select == "both") || (obj.select == "top")) {ctx.fillRect(0, obj.lastPixY, obj.width, pixY - obj.lastPixY)};
      if ((obj.select == "both") || (obj.select == "bottom")) {ctx.fillRect(0, obj.height - pixY, obj.width, pixY - obj.lastPixY)};
    } else if (pixY < obj.lastPixY) {
      ctx.clearRect(0, pixY, obj.width, obj.lastPixY - pixY);
      ctx.clearRect(0, obj.height - obj.lastPixY, obj.width, obj.lastPixY - pixY);
    };
